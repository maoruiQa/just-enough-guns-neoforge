...
/**
 * Standard melee attack goal for regular Zombified Piglins (non-gunners).
 * Ensures they use natural melee behavior without interference from gunner AI.
 */
public class ZombifiedPiglinMeleeAttackGoal extends Goal {
    private final ZombifiedPiglin entity;
    private int raiseArmTicks;
    private int attackCooldown;

    public ZombifiedPiglinMeleeAttackGoal(ZombifiedPiglin entity) {
        this.entity = entity;
