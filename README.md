...
Version `1.7.1` is the current legacy maintenance version for Fabric 26.1. It keeps the 1.7.0 magazine-fed weapon and Walkürenritt vehicle work, then adds repair, localization, vehicle, helicopter, and gun animation fixes.
...
- Fixed Flamethrower reload timing.
- Reduced rocket and missile block damage and splash reach on direct vehicle hits while preserving direct vehicle damage.
- Fixed MI-28 gunner pitch limits and updated helicopter unsafe-descent, crash-damage, rotor, warning HUD/audio, low-energy, and missile-profile behavior.
...
| Loader | Minecraft | Java | Mod Version | Required Dependencies |
| --- | --- | --- | --- | --- |
| Fabric | 26.1 legacy | Java 25 | 1.7.1 | Fabric API, GeckoLib 5.5+ |

Use Fabric 26.2 for the maintained Java 25 release line unless you specifically need this 26.1 legacy build.
