...
public record GunPoseProfile(
    ...
    private static final ArmTransform BONE_DRIVEN_LEFT_ARM = arm(0.04F, -0.02F, 0.08F, 0.0F, 0.0F, 0.0F, 0.60F, 0.74F, 0.60F);
    private static final ArmTransform BONE_DRIVEN_RIGHT_ARM = arm(0.82F, -0.10F, 0.12F, 0.0F, 0.0F, 0.0F, 0.60F, 0.74F, 0.60F);
    private static final ArmTransform HEAVY_SUPPORT_LEFT_ARM = arm(0.82F, -0.40F, 0.14F, 0.0F, 0.0F, 0.0F, 0.58F, 0.72F, 0.58F);
    ...
    private static final GunPoseProfile ROCKET_LAUNCHER_PROFILE = of(
            ...
            0.35F, -0.64F, -0.88F,
            2.0F, 4.0F, 1.22F,
            // Heavy shoulder weapons need an explicit support-hand push toward the weapon body.
            // The neutral correction was too small and left the hand visually stranded on the screen-left side.
            HEAVY_SUPPORT_LEFT_ARM,
            BONE_DRIVEN_RIGHT_ARM
    );
