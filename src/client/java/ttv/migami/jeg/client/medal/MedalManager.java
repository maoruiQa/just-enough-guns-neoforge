...
public final class MedalManager {
    ...
    public static void render(GuiGraphicsExtractor guiGraphics) {
        ...
        int y = 20;
        guiGraphics.blit(RenderPipelines.GUI_TEXTURED, current.texture(), x, y, 0.0F, 0.0F, MEDAL_SIZE, MEDAL_SIZE, MEDAL_SIZE, MEDAL_SIZE);

        int textX = x + (MEDAL_SIZE - minecraft.font.width(current.text())) / 2;
        guiGraphics.text(minecraft.font, current.text(), textX, y + MEDAL_SIZE + 4, 0xFFFFFFFF, true);
    }
