...
public final class CasingParticle extends TextureSheetParticle {
    private CasingParticle(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static final class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            CasingParticle particle = new CasingParticle(level, x, y, z, xSpeed, ySpeed, zSpeed);
