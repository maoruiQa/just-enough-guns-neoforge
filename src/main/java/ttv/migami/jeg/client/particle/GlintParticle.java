...
@OnlyIn(Dist.CLIENT)
public class GlintParticle extends TextureSheetParticle {
   ...
   @OnlyIn(Dist.CLIENT)
   public static class EntityLaserProvider implements ParticleProvider<SimpleParticleType> {
      private final SpriteSet sprite;

      public EntityLaserProvider(SpriteSet pSprites) {
         this.sprite = pSprites;
      }
   ...
   @OnlyIn(Dist.CLIENT)
   public static class HitmarkerProvider implements ParticleProvider<SimpleParticleType> {
      private final SpriteSet sprite;

      public HitmarkerProvider(SpriteSet pSprites) {
         this.sprite = pSprites;
      }
