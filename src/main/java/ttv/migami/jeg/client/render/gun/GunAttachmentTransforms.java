...
public final class GunAttachmentTransforms {
    ...
    private static final Map<ResourceLocation, Map<AttachmentType, Transform>> TRANSFORMS = Map.ofEntries(
            ...
            entry("assault_rifle", scope(0.0D, 4.715D, 5.0D), barrel(0.0D, 3.97D, -4.5D), underBarrel(0.0D, 2.7D, 0.3D), special(-1.0D, 4.0D, 0.0D)),
            ...
            entry("combat_rifle", scope(0.0D, 5.885D, 4.8D), barrel(0.0D, 4.585D, -7.855D), underBarrel(0.0D, 0.0D, 0.0D), special(-1.2D, 4.63D, -1.8D)),
            ...
            entry("hollenfire_mk2", scope(0.0D, 5.305D, 4.5D), underBarrel(0.0D, 2.725D, -1.0D), special(-1.9D, 4.7D, -4.0D)),
            ...
            entry("service_rifle", scope(0.0D, 5.305D, 4.5D), barrel(0.0D, 4.685D, -8.5D), underBarrel(0.0D, 3.3D, -1.0D), special(-1.2D, 4.7D, -3.5D)),
