...
public final class GunAttachmentTransforms {
    ...
    private static final Map<ResourceLocation, Map<AttachmentType, Transform>> TRANSFORMS = Map.ofEntries(
            entry("abstract_gun", barrel(0.0D, 3.97D, -4.5D), underBarrel(0.0D, 2.7D, 0.3D), special(-1.0D, 4.0D, 0.0D)),
            entry("assault_rifle", barrel(0.0D, 3.97D, -4.5D), underBarrel(0.0D, 2.7D, 0.3D), special(-1.0D, 4.0D, 0.0D)),
            entry("blossom_rifle", barrel(0.0D, 5.1D, -9.4D), underBarrel(0.0D, 3.9D, 0.0D), special(-1.1D, 5.0D, -6.2D)),
            entry("bolt_action_rifle", barrel(0.0D, 4.905D, -14.5D), special(-1.0D, 4.0D, -7.0D)),
            entry("burst_rifle", barrel(0.0D, 4.34D, -5.5D), underBarrel(0.0D, 2.975D, -0.78D), special(-1.2D, 4.335D, -2.0D)),
            entry("combat_pistol", barrel(0.0D, 5.5D, -3.2D), special(-0.8D, 5.2D, 0.0D)),
            entry("combat_rifle", barrel(0.0D, 4.585D, -7.855D), scope(0.0D, 8.0D, 0.0D), underBarrel(0.0D, 0.0D, 0.0D), special(-1.2D, 4.63D, -1.8D)),
            entry("custom_smg", barrel(0.0D, 4.475D, -1.2D), special(-0.8D, 3.8D, 0.0D)),
            entry("grenade_launcher", underBarrel(0.0D, 2.5D, -2.5D)),
            entry("hollenfire_mk2", underBarrel(0.0D, 2.725D, -1.0D), special(-1.9D, 4.7D, -4.0D)),
            entry("holy_shotgun", barrel(0.0D, 2.804D, -5.5D), underBarrel(0.0D, 1.77D, 2.125D, 0.0D)),
            entry("infantry_rifle", barrel(0.0D, 4.5D, -9.6D), special(-1.0D, 4.3D, -6.0D)),
            entry("light_machine_gun", barrel(0.0D, 4.855D, -7.0D), underBarrel(0.0D, 2.5D, 0.3D), special(-1.2D, 3.63D, -0.1D)),
            entry("minigun", special(0.0D, 1.2D, 4.0D)),
            entry("phantom_smg", barrel(0.0D, 4.475D, -1.2D), special(-0.8D, 3.8D, 0.0D)),
            entry("pump_shotgun", barrel(0.0D, 4.125D, -5.51D), underBarrel(0.0D, 0.0D, 0.0D), special(-1.0D, 4.0D, -2.0D)),
            entry("repeating_shotgun", barrel(0.0D, 4.65D, -10.0D), underBarrel(0.0D, 3.0D, 0.45D), special(-0.8D, 4.0D, -5.0D)),
            entry("revolver", barrel(0.0D, 4.69D, -3.2D)),
            entry("semi_auto_pistol", barrel(0.0D, 5.4D, -3.2D), special(-0.8D, 5.2D, 0.0D)),
            entry("semi_auto_rifle", barrel(0.0D, 4.425D, -5.5D), underBarrel(0.0D, 3.6D, -2.8D), special(-0.8D, 4.0D, 2.0D)),
            entry("service_rifle", barrel(0.0D, 4.685D, -8.5D), underBarrel(0.0D, 3.3D, -1.0D), special(-1.2D, 4.7D, -3.5D)),
            entry("soulhunter_mk2", underBarrel(0.0D, 3.3D, -4.33D)),
            entry("subsonic_rifle", barrel(0.0D, 4.515D, -8.25D), underBarrel(0.0D, 3.15D, -1.0D)),
            entry("supersonic_shotgun", barrel(0.0D, 4.125D, -5.51D), underBarrel(0.0D, 0.0D, 0.0D)),
            entry("waterpipe_shotgun", special(0.0D, 3.0D, -5.0D))
    );
