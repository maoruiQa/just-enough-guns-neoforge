    ...
    public static List<String> getConfigFactions() {
        if (gunnerMobsList == null) {
            ...
            gunnerMobsList = Arrays.asList(
                ...
                "the_rattlers|2|minecraft:skeleton,minecraft:stray|jeg:custom_smg|jeg:semi_auto_rifle,jeg:combat_rifle,jeg:infantry_rifle|jeg:bolt_action_rifle,jeg:semi_auto_rifle",
