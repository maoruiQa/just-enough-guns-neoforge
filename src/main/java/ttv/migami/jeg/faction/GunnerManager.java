    ...
    public static List<String> getConfigFactions() {
        if (gunnerMobsList == null) {
            ...
            gunnerMobsList = Arrays.asList(
                "night_of_the_undead|1|minecraft:zombie,minecraft:husk,minecraft:parched,minecraft:zombie_villager,minecraft:drowned|jeg:custom_smg,jeg:waterpipe_shotgun|jeg:revolver|jeg:double_barrel_shotgun",
