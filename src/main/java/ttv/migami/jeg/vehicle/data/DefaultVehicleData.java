...
public record DefaultVehicleData(
    ...
    public static final DefaultVehicleData LIGHT_COMBAT = new DefaultVehicleData(
            ...
            160,
            0.6F,
            new EngineInfo(EngineInfo.WHEEL_TEST.type(), 0.038D, 0.34D, 0.14D, 0.80D, 0.0D, 0),
            List.of(new SeatInfo(0, 0.0D, 0.75D, 0.0D, true, true, false)),
            true,
            VehicleContainerType.NONE,
    ...
    public static final DefaultVehicleData TEST_HELICOPTER = new DefaultVehicleData(
            ...
            140,
            0.6F,
            new EngineInfo(EngineType.ROTOR, 0.035D, 0.48D, 0.18D, 0.92D, 0.0D, 0),
            List.of(new SeatInfo(0, 0.0D, 0.85D, 0.0D, true, false, false)),
            true,
            VehicleContainerType.NONE,
    ...
    public static final DefaultVehicleData TEST_BOAT = new DefaultVehicleData(
            ...
            100,
            0.6F,
            new EngineInfo(EngineType.BOAT, 0.035D, 0.36D, 0.14D, 0.86D, 0.0D, 0),
            List.of(new SeatInfo(0, 0.0D, 0.72D, 0.0D, true, false, false)),
            true,
            VehicleContainerType.NONE,
            new CameraPos(0.0D, 2.8D, -6.0D),
            DismountInfo.DEFAULT,
    ...
    public static final DefaultVehicleData TEST_ARTILLERY = new DefaultVehicleData(
            ...
            120,
            0.6F,
            new EngineInfo(EngineType.STATIC, 0.0D, 0.0D, 0.0D, 1.0D, 0.0D, 0),
            List.of(new SeatInfo(0, 0.0D, 0.9D, 0.0D, true, true, false)),
            true,
            VehicleContainerType.NONE,
    ...
    public static final DefaultVehicleData TEST_AIRCRAFT = new DefaultVehicleData(
            ...
            150,
            0.6F,
            new EngineInfo(EngineType.JET, 0.03D, 0.65D, 0.12D, 0.94D, 0.0D, 0),
            List.of(new SeatInfo(0, 0.0D, 0.8D, 0.0D, true, false, false)),
            true,
            VehicleContainerType.NONE,
