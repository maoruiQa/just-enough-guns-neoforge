...
public final class VehicleSoundHelper {
    ...
    private static final Identifier MISSILE_LOCKING = Reference.id("vehicle.missile_locking");
    private static final Identifier MISSILE_LOCKED = Reference.id("vehicle.missile_locked");
