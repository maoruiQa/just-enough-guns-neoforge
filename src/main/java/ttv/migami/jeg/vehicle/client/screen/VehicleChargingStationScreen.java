...
public final class VehicleChargingStationScreen extends AbstractContainerScreen<VehicleChargingStationMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (maxEnergy <= 0) {
            guiGraphics.drawString(this.font, NO_TARGET, x + 10, y + 44, 0xFFE6E6E6);
            return;
        }
        ...
        guiGraphics.drawString(this.font, Component.translatable("gui.jeg.vehicle_charging_station.energy", energy, maxEnergy), x + 10, y + 44, 0xFFE6E6E6);
        guiGraphics.drawString(this.font, this.menu.isCharging() ? STATUS_CHARGING : STATUS_IDLE, x + 10, y + 56, 0xFFE6E6E6);
    }
