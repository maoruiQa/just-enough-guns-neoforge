...
public final class ModSounds {
    ...
    public static final Map<Identifier, DeferredHolder<SoundEvent, SoundEvent>> ALL = new LinkedHashMap<>();

    static {
        for (Identifier id : loadSoundKeys()) {
            register(id);
        }
    }
    ...
    private static JsonObject readSoundsJson() {
        Identifier path = Identifier.fromNamespaceAndPath(Reference.MOD_ID, "sounds.json");
