...
public class ModSyncedDataKeys
{
    ...
    public static final SyncedDataKey<Player, Integer> BURST_COUNT = SyncedDataKey.builder(SyncedClassKey.PLAYER, Serializers.INTEGER)
            .id(new ResourceLocation(Reference.MOD_ID, "burst_count"))
