    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            for(IGunModifier modifier : modifiers)
            {
                ...
                {
                    addPerk(positivePerks, true, "perk.jeg.flashlight.positive");
                    break;
                }
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                if(modifier.laserPointer())
                {
                    addPerk(positivePerks, true, "perk.jeg.laser_pointer.positive");
                    break;
                }
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                if(modifier.annoying())
                {
                    addPerk(positivePerks, true, "perk.jeg.annoying.positive");
                    break;
                }
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                if(modifier.explosiveAmmo())
                {
                    addPerk(positivePerks, true, "perk.jeg.explosive_ammo.positive");
                    break;
                }
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                if(modifier.increasedJamming())
                {
                    addPerk(negativePerks, false, "perk.jeg.increased_jamming.negative");
                    break;
                }
            }
