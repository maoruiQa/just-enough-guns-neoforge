...
public final class GunAttachmentRules {
    private static final Map<Identifier, Set<AttachmentType>> SUPPORTED_TYPES = Map.ofEntries(
    ...
    private static Map.Entry<Identifier, Set<AttachmentType>> support(String gunId, AttachmentType... types) {
