...
public class FlashlightAttachmentItem extends AttachmentItem {
    ...
    public void inventoryTick(ItemStack stack, ServerLevel level, Entity entity, EquipmentSlot slot) {
        ...
        boolean selected = stack == player.getMainHandItem() || stack == player.getOffhandItem();
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.accept(Component.translatable("info.jeg.tooltip_item.flashlight").withStyle(ChatFormatting.GRAY));
        tooltipAdder.accept(Component.empty());
        tooltipAdder.accept(Component.translatable("info.jeg.tooltip_item.flashlight_help").withStyle(ChatFormatting.GRAY));
        tooltipAdder.accept(Component.translatable("info.jeg.tooltip_item.flashlight_help_gun", Component.translatable("key.jeg.melee")).withStyle(ChatFormatting.GRAY));
    }
    ...
    private static void playSound(Level level, Player player, Identifier id, float volume, float pitch) {
