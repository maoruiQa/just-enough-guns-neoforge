...
public class ArrowProjectileEntity extends Projectile {
    ...
    protected void readAdditionalSaveData(CompoundTag input) {
        ...
        this.lifetime = input.contains("Lifetime") ? input.getInt("Lifetime") : this.lifetime;
        this.flaming = input.contains("Flaming") ? input.getBoolean("Flaming") : this.flaming;
        this.charged = input.contains("Charged") ? input.getBoolean("Charged") : this.charged;
    }
