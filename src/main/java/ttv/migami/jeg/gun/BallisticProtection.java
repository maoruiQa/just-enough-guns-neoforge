...
public final class BallisticProtection {
    ...
    private static final Identifier HANDMADE_SHELL = Reference.id("handmade_shell");
    private static final Identifier SHOTGUN_SHELL = Reference.id("shotgun_shell");
    private static final Identifier PISTOL_AMMO = Reference.id("pistol_ammo");
    private static final Identifier SPECTRE_ROUND = Reference.id("spectre_round");
    private static final Identifier BLAZE_ROUND = Reference.id("blaze_round");
    ...
    private static final Identifier ECHO_SHARD = Identifier.fromNamespaceAndPath("minecraft", "echo_shard");
    private static final Identifier SCULK_CATALYST = Identifier.fromNamespaceAndPath("minecraft", "sculk_catalyst");
    private static final Identifier SUBSONIC_RIFLE = Reference.id("subsonic_rifle");
    private static final Identifier SUPERSONIC_SHOTGUN = Reference.id("supersonic_shotgun");
    private static final Identifier HYPERSONIC_CANNON = Reference.id("hypersonic_cannon");
    private static final Identifier ROCKET_LAUNCHER = Reference.id("rocket_launcher");
