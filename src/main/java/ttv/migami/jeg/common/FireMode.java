...
public class FireMode
{
    ...
    /**
     * A fire mode that shoots once per trigger release
     */
    public static final FireMode RELEASE_FIRE = new FireMode(new ResourceLocation(Reference.MOD_ID, "release_fire"));
