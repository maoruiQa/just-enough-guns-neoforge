...
public class ReloadType
{
    ...
    /**
     * A reload system which takes 1 item to fill an entire gun (does not allow unloading the gun)
     */
    public static final ReloadType SINGLE_ITEM = new ReloadType(new ResourceLocation(Reference.MOD_ID, "single_item"));

    /**
     * A reload system which takes 1 itemStack from the inventory after shooting
     */
