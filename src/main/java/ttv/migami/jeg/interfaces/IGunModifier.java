...
public interface IGunModifier
{
    ...
    /**
     * Determines if the ammo shot by this Gun should explode && break Stone blocks.
     *
     * @return if the gun shoots explosive ammo
     */
    default boolean explosiveAmmo()
    {
        return false;
    }

    /**
     * Determines if this attachment makes the gun more prone to jamming.
     *
     * @return if jam = more
     */
    default boolean increasedJamming()
    {
        return false;
    }

    default boolean playerKnockback()
    {
        return false;
    }

    default boolean flashlight()
    {
        return false;
    }

    default boolean laserPointer()
    {
        return false;
    }

    default boolean annoying()
    {
        return false;
    }
